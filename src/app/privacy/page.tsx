  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      ...
      <div className="prose prose-lg max-w-none">
        ...
        <h2 className="text-2xl font-display font-semibold mt-8 mb-4">2. Information We Collect</h2>

        <h3 className="text-xl font-display font-semibold mt-6 mb-3">2.1 Personal Information</h3>
        ...
        <ul className="list-disc pl-6 mb-4">
          ...
          <li>Content you upload (such as photos)</li>
          <li>Information about children (such as names, ages, preferences)</li>
        </ul>
        ...
        <ul className="list-disc pl-6 mb-4">
          ...
          <li>Create and personalize your stories</li>
        ...
        <ul className="list-disc pl-6 mb-4">
          <li>
            ...
            (e.g., payment processors, cloud storage providers, printing services)
          </li>
          <li>
            <strong>Business Partners:</strong> Trusted partners who help us operate our business
        ...
        <h2 className="text-2xl font-display font-semibold mt-8 mb-4">5. Children's Privacy</h2>
        <p>
          Our services are designed for parents and guardians to create personalized stories for
          children. We do not knowingly collect personal information directly from children under
          13. All information about children is provided by parents or guardians. We take special
          care to protect the privacy of children and comply with the Children's Online Privacy
        ...
        <h2 className="text-2xl font-display font-semibold mt-8 mb-4">7. Data Security</h2>
        <p>
        ...
        <p>
          ...
          of residence. These countries may have different data protection laws. We ensure
          appropriate safeguards are in place to protect your information when transferred
          internationally.
        </p>
        ...
        <p>
          ...
          browsing activities. You can manage your cookie preferences through your browser settings.
        </p>
        ...
        <p>
          ...
          by an updated "Last Updated" date. We encourage you to review this Privacy Policy
          periodically.
        </p>

        <h2 className="text-2xl font-display font-semibold mt-8 mb-4">11. Contact Us</h2>
        <p>
